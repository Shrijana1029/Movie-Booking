                    ...
                    <div class="booking-form-container">
                        <form action="spot.php" method="POST">
                            ...
                            <select name="date" required>
                                ...
                                <option value="12-3">October 1,2023</option>
                                <option value="13-3">October 2,2023</option>
                                <option value="14-3">October 3,2023</option>
                                <option value="15-3">October 4,2023</option>
                                <option value="16-3">October 5,2023</option>
                            </select>
